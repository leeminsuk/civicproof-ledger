...
def main() -> int:
    ...
    checks: list[tuple[str, int, bool]] = [
        ...
        ("Interactive demo has hero canvas, attack theater, and tamper demo button", 6, all(token in read("web/index.html") for token in ["hero-canvas", "run-attacks", "tamper-demo", "play-scenario"])),
